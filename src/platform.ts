 ...
 */
export class PrinterHomebridgePlatform implements DynamicPlatformPlugin {
  ...
  discoverDevices(config:PlatformConfig) {
    ...
    for (const device of devices) {
      ...
      if (existingAccessory) {
        ...
        new FDM_Printer(this, existingAccessory);
        ...
        // this is imported from `platformAccessory.ts`
        new FDM_Printer(this, accessory);
